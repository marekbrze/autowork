...
export const runsFull: Run[] = [
  {
    id: 'run-finanse',
    name: 'Finances and the loan payment',
    state: 'in_progress',
    ...
    reviewItems: [
      { id: 'ri-1', kind: 'stressor', text: 'unpaid invoices', stale: false },
      { id: 'ri-2', kind: 'task', text: 'Call the loan advisor', stale: true },
      { id: 'ri-3', kind: 'task', text: 'Request time off on short notice', stale: false },
      { id: 'ri-4', kind: 'stressor', text: 'talk to the boss about a raise', stale: false },
    ],
  ...
  },
  {
    ...
    stats: { timeSpentSec: 900, doneCount: 2, dismissedCount: 0, totalTasks: 9, estimatedTotalMin: 270, estimatedRemainingMin: 210 },
    reviewItems: [],
  ...
  },
  {
    ...
    stats: { timeSpentSec: 0, doneCount: 0, dismissedCount: 0, totalTasks: 6, estimatedTotalMin: 0, estimatedRemainingMin: 0 },
    reviewItems: [],
    createdAt: '2026-06-28T21:40:00.000Z',
    updatedAt: '2026-06-28T21:40:00.000Z',
    lastActiveAt: '2026-06-28T21:40:00.000Z',
  ...
  },
  {
    ...
    state: 'archived',
    lastReachedStep: 'celebration',
    stats: { timeSpentSec: 5400, doneCount: 20, dismissedCount: 1, totalTasks: 22, estimatedTotalMin: 660, estimatedRemainingMin: 30 },
    reviewItems: [],
